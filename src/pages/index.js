...
const IndexPage = () => (
  <Layout>
    ...
    <div style={{textAlign: 'center'}}><iframe title="5-min Open Eugene Explaination c/ Mark Davis" width="90%" height="315" src="https://www.youtube-nocookie.com/embed/8VDYcNPw9zA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
